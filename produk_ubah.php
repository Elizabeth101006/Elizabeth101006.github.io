<?php
$id = $_GET['id'];
    if(isset($_POST['nama_produk'], $_POST['harga'], $_POST['stok'])) {
                        ...
                        <form method="post">
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td width>:</td>
                                    <td><input class="form-control" value="<?php echo isset($data['nama_produk']) ? htmlspecialchars($data['nama_produk']) : ''; ?>" type="text" name="nama_produk"></td>
